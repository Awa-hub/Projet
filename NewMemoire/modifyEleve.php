                ...
                <div class="page-content">
                   ...
                   <!-- start widget -->
                    ...
                    <?php
                        ...
                        $classe = $traitement->getClasseLibelleById($eleve['id_classe']); //On recupère la classe par id
                        $allAnnees = $traitement->getAnnee(); //On récupère toutes les années
                        $annee = $traitement->getAnneeById($eleve['annee']);
                    ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="prenom" value="<?= $eleve['prenom'] ?>" required autocomplete="off">
                        </div>
                            <div class="form-group col-md-6">
                                <label for="nom">Nom</label>
                                <input type="text" class="form-control" name="nom" value="<?= $eleve['nom'] ?>" required autocomplete="off">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lieu" value="<?= $eleve['lieu_naiss'] ?>" required autocomplete="off">
                                </div>                                          
                                 </div>         
                               </div>
                               <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="adresse" value="<?= $eleve['adresse'] ?>" required autocomplete="off">
                                </div>
                             </div>            
                               </div>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <select id="inputState" class="form-control" name="annee" required>
                                <option value="<?= $eleve['annee'] ?>" selected hidden><?= $annee['annee_scolaire'] ?></option>
                                <?php foreach($allAnnees as $annee): ?>
                                    <option value="<?= $annee['id_annee'] ?>"><?= $annee['annee_scolaire'] ?></option>
                                <?php endforeach; ?>
                            </select>
                          </div>
                         <!-- <div class="form-group col-md-6">
                            <label for="annee">Année scolaire</label>
                            <input type="text" class="form-control"  name="annee" value="<?= $eleve['annee'] ?>" required autocomplete="off">
                          </div> -->
                          </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="pere" value="<?= $eleve['pere'] ?>" required autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="mere">et de</label>
                            <input type="text" class="form-control" name="mere" value="<?= $eleve['mere'] ?>" required autocomplete="off">
                        </div>
                    </div>
                        <div class="form-group col-md-6">
