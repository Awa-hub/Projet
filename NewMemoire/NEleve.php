...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
                   ...
                   <!-- start widget -->
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lieu" required autocomplete="off">
                                </div>                                          
                                 </div>         
                               </div>
                               <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Date" name="adresse" required autocomplete="off">
                                </div>
                             </div>            
                               </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="pere" required autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="mere">et de</label>
                            <input type="text" class="form-control" name="mere" required autocomplete="off">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="contact">Contact du titulaire</label>
                            <input type="number" class="form-control" name="contact" required autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Frais d'inscription</label>
                            <input type="number" class="form-control" name="frais_inscription" required autocomplete="off">
                        </div>
                        </div>
                        <div class="form-group col-md-6">
                            <input type="hidden" class="form-control" name="n_matricule" value="<?= rand() ?>">
                        </div>
                        <!-- <div class="form-group col-md-6">
                            <input type="hidden" class="form-control" value="<?= date('Y-m-d') ?>" name="date_ins" required>
                        </div> -->
                        <div class="form-group col-md-6">
                            <input type="hidden" class="form-control" value="<?= date('Y-m-d') ?>" name="date_ins" required>
                        </div>
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-info" onclick="success_toast()">Valider l'inscription</button>
                        </div>
                        </div>
    ...
    <script src="assets/js/jquery3.3.1-comp.js"></script>
