                   ...
                   <!-- start widget -->
                    ...
                    <div class="page-bar">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="libelle" required autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                             ...
                             <button type="submit" class="btn btn-info" onclick="success_toast()">Enregistrer</button>
                                            </div>
                                        </div>
                                        </div>
                                    </form>
