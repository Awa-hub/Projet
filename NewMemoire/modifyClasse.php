                ...
                <div class="page-content">
                   ...
                   <!-- start widget -->
                    ...
                    <div class="page-bar">
                        ...
                        $classe = $traitement->getClasseById($_GET['id']); //On recupère la classe par id
                    ?>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent2">
                                    <form action="traitement/modifyClasseById.php?id=<?= $classe['id_classe'] ?>" method="post" class="form-horizontal">
                                    <div class="form-row">
