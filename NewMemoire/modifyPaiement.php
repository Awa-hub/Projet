                ...
                <div class="page-content">
                   ...
                   <!-- start widget -->
                    ...
                    <?php
                        ...
                        $paiement = $traitement->getPaymentById($_GET['id']);
                    ...
                    ?>
                        ...
                        <form action="traitement/modifyPaiementById.php?id=<?= $paiement['id_paiement'] ?>&id_classe=<?= $_GET['id_classe'] ?>&id_eleve=<?= $_GET['id_eleve'] ?>" method="post" class="form-horizontal">  
                        <div class="form-row">
                        <div class="form-group col-md-6">
                        <label for="type">Type de paiement</label>
                                    <select id="inputState" class="form-control" name="type_paiement" required>
                                        <option></option>
                                        <option selected><?= $paiement['type_paiement']?></option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control"  name="nature_paiement" value="<?=$paiement['nature_paiement']?>" required>
                        </div>
                        </div>
                        <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <option></option>
                            <option value="<?= $paiement['id_annee'] ?>" selected><?= $traitement->getAnneeById($paiement['id_annee'])['annee_scolaire']?></option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control"  name="montant_fixe" value="<?=$paiement['montant_fixe']?>" required>
                        </div>
                        </div>
                        <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="">Reduction</label>
                            <input type="number" class="form-control" name="reduction" value="<?=$paiement['reduction']?>" required autocomplete="off">
                        </div>
                        </div>
