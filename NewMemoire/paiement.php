                    ...
                    ?>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><h3>Paiement de <?= $Eleve['nom'] ?> <?= $Eleve['prenom'] ?> </h3></header>
                        ...
                        <form action="traitement/add-new-paiement.php?id_eleve=<?= $_GET['id_eleve'] ?>&id_classe=<?= $_GET['id_classe']?>" method="post" class="form-horizontal"> 
                        
                        <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="">Numéro de reçu</label>
                            <input type="number" class="form-control" name="n_recu" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control"  name="nature_paiement" value="Frais de scolarité" required>
                        </div>   
                        <div class="form-group col-md-6">
                            <label for="">Montant fixe</label>
                            <input type="number" class="form-control"  name="montant_fixe" required>
                        </div>
                        </div>
                        <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" name="reduction" required autocomplete="off">
                        </div>
                        <div class="form-row">
                        <div class="form-group col-md-6">
                            <input type="hidden" class="form-control" value="<?= date('Y-m-d') ?>" name="date_paiement" required>
                        </div>
                        </div>
                        </div>
