...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-itms-center">
                ...
                <form action="traitement/modifyPassword.php" method="post">
                    <div class="card card-topline-aqua" style="margin-right: -25px;">
                        <div class="card-body no-padding height-9">
                            ...
                            <ul class="list-group list-group-unbordered">
                                ...
                                <b>Ancien: </b><input type="password" name="ancien" style="border:none;" autocomplete="off">
                                </li>
                                <li class="list-group-item">
                                <b>Nouveau: </b><input type="password" name="nouveau" style="border:none;" autocomplete="off">
                                </li>
                                <li class="list-group-item">
                                <b>Confirme: </b><input type="password" name="confirme" style="border:none;" autocomplete="off">
                                </li>
                            </ul>
                        </div>
                            <div class="form-group col-md-5" style="padding: 30px">
                            <button type="submit" class="btn btn-info me-5" >Changer</button>
                            </div>
                    </div>
                    </form>
                    </div>
    ...
    <!-- end page content -->
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2021 &copy; Design by Awa
            </div>
